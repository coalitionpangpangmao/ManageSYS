                    ...
                    <tr>
                        ...
                        <table  class = "tablelist">
                                <tr>
                                    <th colspan="4" >
                                        ...
                                        <asp:Button ID="btnView" 
                                            runat="server" Text="Button" onclick="btnView_Click" CssClass = "btnhide"/>
                                    </th>
                                </tr>
                                <tr>
                                    <td width="100px">
                                    ...
                                    <td  >
                                        <asp:DropDownList ID="listSection" runat="server"  CssClass= "drpdwnlist" 
                                            AutoPostBack="True" onselectedindexchanged="listSection_SelectedIndexChanged" >
                                        </asp:DropDownList>
                                    </td>
                                     <td width="100px">
                                        权重：
                                ...
                                <tr>
                                    ...
                                    <td >
                                        <asp:DropDownList ID="listPointname" runat="server" CssClass= "drpdwnlist" 
                                            AutoPostBack="True" 
