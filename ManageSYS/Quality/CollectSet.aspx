                                ...
                                <td>
                                    <table class="tablelist">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <asp:TextBox ID="txtDescript" runat="server" CssClass="dfinput1" Width="300px"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td>
                                    <table class="tablelist">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtBatchHDelay" runat="server" CssClass="tbinput">0</asp:TextBox>秒
                                            </td>
                                            <td>批尾延时：
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtBatchTDelay" runat="server" CssClass="tbinput">0</asp:TextBox>秒
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>采集周期
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtPeriodic" runat="server" CssClass="tbinput"></asp:TextBox>秒</td>
                                            <td>料头延时:
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtHeadDelay" runat="server" CssClass="tbinput">0</asp:TextBox>秒
                                            </td>
                                            <td>料尾延时：
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtTailDelay" runat="server" CssClass="tbinput">0</asp:TextBox>秒
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>判定时长
