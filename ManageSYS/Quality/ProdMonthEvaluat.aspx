<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProdMonthEvaluat.aspx.cs" Inherits="Quality_ProdMonthEvaluat" %>
            ...
            <table class="tablelist" style="margin-bottom: 8px">
                <tr>
                    ...
                    <asp:TextBox ID="txtStartTime" runat="server" onclick="WdatePicker({dateFmt:'yyyy-MM'})"
                        CssClass="dfinput1"></asp:TextBox>     产品：    <asp:DropDownList ID="listProd" runat="server" CssClass ="drpdwnlist"></asp:DropDownList>             
                      
                        <asp:Button ID="btnSearch" runat="server" CssClass="btnview" Text="查询" OnClick="btnSearch_Click" />                  
                     <asp:Button ID="btnExport" runat="server" CssClass="btnset" Text="导出" OnClick="btnExport_Click" />                  
            ...
            <div id="usual1" class="usual">
                <div class="itab">
                    <ul>
                        ...
                        <li><a href="#tab2" id="tabtop2">理化检测</a></li>
                        <li><a href="#tab3" id="tabtop3">感观评测</a></li>
                        <li><a href="#tab4" id="tabtop4">过程检测</a></li>
                    </ul>
                </div>
            </div>
