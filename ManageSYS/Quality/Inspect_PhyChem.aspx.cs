...
public partial class Quality_Inspect_Process : MSYS.Web.BasePage
{
    ...
    protected void initView()
    {
       MSYS.Data.SysUser user =  (MSYS.Data.SysUser)Session["User"];
        ...
        string query = "select r.inspect_code,s.name as insgroup,r.inspect_name,0 as value,t.lower_value,t.upper_value,r.unit,'' as status,t.minus_score from ht_qlt_inspect_proj r left join ht_inner_inspect_group s on s.id = r.inspect_group left join ht_qlt_inspect_stdd t on t.inspect_code = r.inspect_code where r.inspect_group in('1','2','3')";
