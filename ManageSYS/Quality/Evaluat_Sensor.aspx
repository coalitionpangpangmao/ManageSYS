    ...
    <form id="Form1" runat="server">
        ...
        <div class="mainbox">
            <table class="tablelist" style="margin-bottom: 5px">
                <tbody>
                    <tr>
                        <td colspan="7" align="center">请选择时间：     
            ...
            <div id="usual1" class="usual">
                <div class="itab">
                    <ul>
                        <li><a href="#tab1" class="selected" id="tabtop1">感观评测得分</a></li>
                        <li><a href="#tab2" id="tabtop2">感观评测报告</a><span onclick="$('#tabtop1').click();$('#tabtop2').parent().hide(); $('#btnPrint').hide(); $('#btnExport').hide();"></span></li>
                        <li><a href="#tab3" id="tabtop3">得分详情</a><span onclick="$('#tabtop1').click();$('#tabtop3').parent().hide(); "></span></li>
                    </ul>
                </div>
            </div>
