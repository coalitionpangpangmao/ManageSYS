...
x.Field<String>("name")).Select(x => x.First()).ToList();
    ...
    private void createView()
    {
        ...
        if (data != null && data.Tables[0].Rows.Count > 0)
        {
            ...
            opt.UpDateOra("create or replace view hv_Sensor_daily_report as " + sql.ToString());
        }
