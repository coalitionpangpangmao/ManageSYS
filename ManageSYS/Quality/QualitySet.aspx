...
<body>
                ...
                <tr>
                    <td colspan="2">
                       <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                        <div class="listtitle">
                            标准版本信息<asp:DropDownList ID="listVersion" runat="server" CssClass = "drpdwnlist" 
    ...
    CssClass= "drpdwnlist" onselectedindexchanged="listParaName_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
                                                ...
                                                <asp:TemplateField HeaderText="判断条件" SortExpression="判断条件">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtDevM" runat="server" DataValueField="判断条件" DataTextField="判断条件" CssClass="tbinput"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
