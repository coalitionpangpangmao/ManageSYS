<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Evaluat_Process.aspx.cs" Inherits="Quality_Evaluat_Process" %>
    ...
    <form id="Form1" runat="server">
        ...
        <div class="mainbox">
            ...
            <div id="usual1" class="usual">
                <div class="itab">
                    <ul>
                        <li><a href="#tab1" class="selected" id="tabtop1">过程检测得分</a></li>
                        <li><a href="#tab2" id="tabtop2">过程检测报告</a><span onclick="$('#tabtop1').click();$('#tabtop2').parent().hide(); $('#btnPrint').hide(); $('#btnExport').hide();"></span></li>
