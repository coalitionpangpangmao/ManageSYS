...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(".click4").click(function () {
            ...
            $("#energyConsumptionPoint").attr("value", "");
...
<asp:ScriptManager ID="ScriptManager1" runat="server"> 
 ...
 <table class="tablelist">    	
        ...
        <td width="100">能耗点</td>
        <td>
                 <asp:DropDownList ID="energyConsumptionPoint" runat="server" CssClass="drpdwnlist"></asp:DropDownList>
        </td>
        <td  width="100">工序名</td>
        <td>
        ...
        <tr>
            <td  width="100">ID</td>
            <td><asp:TextBox ID="consumeID" runat="server" class="dfinput1" ReadOnly="TRUE" ></asp:TextBox></td>
        ...
        <li class="click4"><span></span>清空</li>
