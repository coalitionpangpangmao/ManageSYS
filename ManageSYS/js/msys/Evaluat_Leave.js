...
buildCreateTime(){
    return new Date().toLocaleString();
        ...
        addTable(isInsert){
            ...
            jsonData.produceTime1S = this.getInputValue("producetime1_s");
            jsonData.produceTime1E = this.getInputValue("producetime1_e");
            jsonData.produceTime2S = this.getInputValue("producetime2_s");
            jsonData.produceTime2E = this.getInputValue("producetime2_e");
            jsonData.produceTime3S = this.getInputValue("producetime3_s");
            jsonData.produceTime3E = this.getInputValue("producetime3_e");
