<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StorageFlaOut.aspx.cs" Inherits="Product_StorageFlaOut" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>香精香料领用管理</title>
    ...
    <form id="form1" runat="server">
        ...
        <div class="formbody">
            <div id="usual1" class="usual">
                <div class="itab">
                    <ul>
                        <li><a href="#tab1" class="selected" id="tabtop1">领用管理</a></li>
                        <li><a href="#tab2" id="tabtop2">领用明细</a></li>
                    </ul>
                </div>
            </div>
            <div id="tab1" class="tabson">
                ...
                <div class="listtitle" style="margin-top: 10px">
                    香精香料领用表<span style="position: relative; float: right">
            ...
            <div id="tab2" class="tabson">
                ...
                <div>
                    <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div class="listtitle">
                                香精香料领用管理<span style="position: relative; float: right" class="click2">
                            ...
                            <table class="tablelist">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtBatchNum" Visible="false" runat="server" class="dfinput1"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                            ...
                            <asp:GridView ID="GridView2" runat="server" class="grid" AllowPaging="True" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField   HeaderText="计量单位" SortExpression="计量单位">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtGridUnit" Visible="false" runat="server" DataValueField="计量单位" DataTextField="计量单位"
