<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StorageMaterOut.aspx.cs" Inherits="Product_StorageMaterOut" %>
                                    ...
                                    <asp:TemplateField   HeaderText="仓库" SortExpression="仓库">
                                        <ItemTemplate>
                                            <asp:DropDownList ID="listGridstrg" runat="server" CssClass="drpdwnlist">
                                                ...
                                                <asp:ListItem Value="3">鑫源原材料</asp:ListItem>
