<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InOutRecord.aspx.cs" Inherits="Product_InoutRecord" %>
            ...
            <div class="framelist">
                ...
                <div class="listtitle" style="margin-top: 10px">
                    <span style="position: relative; float: right">
                        ...
                        <asp:Button ID="btnAdd" CssClass="btnadd" runat="server" OnClick="btnAdd_Click"
                            Text="新增" />
                        <asp:Button ID="btnDelSel" runat="server" CssClass="btndel" Text="删除" OnClick="btnDelSel_Click" OnClientClick="javascript:return confirm('确认删除？');" />
                    </span>
                </div>
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="GridView1" runat="server" class="grid" AllowPaging="True" DataKeyNames="rowid"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="当班时间" HeaderText="当班时间" />
             ...
             <asp:LinkButton ID="btnGo" runat="server" CausesValidation="False" CommandArgument="-2"
                ...
                <div class="shade">
                    <div class="recordinfo">
                        <div class="tiphead">
                            <span>投入产出记录</span><a onclick="$('.shade').fadeOut(100);"></a>
                        </div>
                        <div class="gridinfo">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
                                <ContentTemplate>
                                    <table class="tablelist">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="listProd2" runat="server" CssClass="drpdwnlist"  onblur ="$('#btnView').click()" ></asp:DropDownList>

                                                    <td width="100">日期
                                                    </td>
                                                    <td width="100">
                                                        <asp:TextBox ID="txtDate" runat="server" CssClass="dfinput1" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" ></asp:TextBox>
                                                    </td>
                                                    <td width="100">班组
                                                    </td>
                                                    <td>
                                                        <asp:DropDownList ID="listTeam2" runat="server" CssClass="drpdwnlist" onblur ="$('#btnView').click()"></asp:DropDownList>
                                                    </td>
                                            </tr>
                                    ...
                                    <asp:GridView ID="GridView2" runat="server" class="grid" DataKeyNames="para_code"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="参数值">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtParavalue" runat="server" CssClass="tbinput"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
