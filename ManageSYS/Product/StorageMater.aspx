                    ...
                    <ContentTemplate>
                        <asp:GridView ID="GridView1" runat="server" class="grid" DataKeyNames="单据号"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField ItemStyle-Width="80">
                                    <ItemTemplate>
                                        <asp:Button ID="btnGridopt" runat="server" Text="出入库" CssClass="btn1" Width="75"
            ...
            <div class="framelist">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="listPrdctPlan" runat="server" CssClass="drpdwnlist" 
                                    onselectedindexchanged="listPrdctPlan_SelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                            <td width="100">
                                产品名称
                ...
                <div class="listtitle" style="margin-top: 10px">
                    领退明细<span style="position: relative; float: right">
                      <asp:Button ID="btnCreate" runat="server" CssClass="btnview" 
                        Text="按明细生成领退单" OnClick="btnCreate_Click" Width="160px" />
