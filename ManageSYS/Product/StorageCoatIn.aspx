<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StorageCoatIn.aspx.cs" Inherits="Product_StorageCoatIn" %>
        ...
        <div class="formbody">
            ...
            <div id="tab1" class="tabson">
                ...
                <div class="listtitle" style="margin-top: 10px">
                    回填液退库表<span style="position: relative; float: right">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField   HeaderText="出入库状态">
                                     ...
                                     <asp:BoundField    DataField="产品" HeaderText="产品" />
                                      <asp:BoundField    DataField="投料批次" HeaderText="投料批次" />                                                     <asp:BoundField    DataField="领退日期" HeaderText="领退日期" />                                                      <asp:BoundField    DataField="回填液总量" HeaderText="回填液总量(Kg)" />
            ...
            <div id="tab2" class="tabson">
                ...
                <div>
                    <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div class="listtitle">
                                回填液领退管理<span style="position: relative; float: right" class="click2">
                            ...
                            <asp:GridView ID="GridView2" runat="server" class="grid" AllowPaging="True" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField   HeaderText="计量单位" SortExpression="计量单位">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtGridUnit" ReadOnly="true" Visible="false" runat="server" DataValueField="计量单位" DataTextField="计量单位"
