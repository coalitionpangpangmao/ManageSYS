...
<body>
   ...
   <div   class="framelist">
    ...
    <table class="tablelist">    	
        ...
        <td>
            <asp:DropDownList ID="list2Section" runat="server" CssClass = "drpdwnlist" 
                onselectedindexchanged="list2Section_SelectedIndexChanged" 
                AutoPostBack="True">
            </asp:DropDownList>
        </td>
        <td  width="100">编码</td>
        ...
        <td>
            <asp:CheckBox ID="rdValid" runat="server" Text=" " /></td>
