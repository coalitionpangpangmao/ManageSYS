...
<body>
 ...
 <div class="gridtools  auth">               
                    ...
                    <asp:Button ID="btnModify" CssClass="btnview  auth" runat="server" OnClick="btnModify_Click"
                        Text="保存" />
                    &nbsp; &nbsp;
                    <asp:Button ID="btnDel" CssClass="btndel  auth" runat="server" Text="删除" OnClick="btnDel_Click" />                    <asp:Button ID="btnUpdate" runat="server" onclick="btnUpdate_Click" CssClass="btnhide" 
                        />
