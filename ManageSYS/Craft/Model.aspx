            ...
            <div id="usual1" class="usual">
                <div class="itab">
                    <ul>
                        ...
                        <li ><a href="#tab2" id = "tabtop2">工序段</a></li>  
                        <li ><a href="#tab3" id = "tabtop3">参数点</a></li>
                    </ul>
                </div>
                <div id="tab1" class="tabson">
                    <iframe id = "sessionFrame" name="sessionFrame" src="Tech_Session.aspx" height="400" scrolling="no" style="width: 80%; position: absolute">
                    </iframe>
                </div>
                <div id="tab2" class="tabson">
                    <iframe id = "ProcessFrame" name= "ProcessFrame" src="Tech_Process.aspx" height="400" scrolling="no" style="width: 80%; position: absolute">
                    </iframe>
                </div>            
                <div id="tab3" class="tabson">
                    <iframe  id = "ParaFrame" name= "ParaFrame" src="Tech_Para.aspx" height="400" scrolling="no" style="width: 80%; position: absolute">
                    </iframe>
                </div>
            </div>        
        </div>
