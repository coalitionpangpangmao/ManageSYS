            ...
            <asp:GridView ID="GridView1" runat="server" class="grid" AllowPaging="True" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="物料名称" SortExpression="物料名称">
                        <ItemTemplate>
                            <asp:DropDownList ID="listGridName" runat="server" CssClass = "drpdwnlist" OnSelectedIndexChanged = "listGirdName_SelectedIndexChanged" AutoPostBack="True" DataSource = '<%# gridTypebind()%>' DataValueField="material_code" DataTextField="material_name">
                            </asp:DropDownList>
                        </ItemTemplate>
                    </asp:TemplateField>
