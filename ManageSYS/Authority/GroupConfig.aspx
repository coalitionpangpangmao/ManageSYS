...
<body>
 <form id="form1" runat="server">
      ...
      <asp:GridView ID="GridView1" runat="server" class="grid"  AutoGenerateColumns="False"
                            ...
                            <Columns>
                               <asp:TemplateField HeaderText="权限ID">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtID" runat="server" DataValueField="权限ID" DataTextField="权限ID"   Width = "50px"   CssClass="tbinput" Enabled="False"></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>                                                                
                                ...
                                <asp:TemplateField HeaderText="父节点名">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtPrntMenu" runat="server" DataValueField="父菜单名" DataTextField="父菜单名"
                                ...
                                <asp:TemplateField HeaderText="URL">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtURL" runat="server" DataValueField="URL" DataTextField="URL"  Width = "200px" CssClass="tbinput" ></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="True">
                ...
                <asp:Label ID="SelValue" runat="server" Text="" 
                Visible="False"></asp:Label>
        ...
        <td style="border: thin solid #a7b5bc" valign="top">
            <asp:TreeView ID="RightTree" runat="server" Width="150px" 
                onselectednodechanged="RightTree_SelectedNodeChanged" >
            </asp:TreeView>
        </td>
        <td>
        <ul class="forminfo">
    <li><label>角色<b>*</b></label><asp:TextBox ID="Role" runat="server" class="dfinput" Text="请填写用户组名"  style="width:518px;"></asp:TextBox></li>
    <li><label>组权限<b>*</b></label>
    <table><tr>
        <td style="border: thin solid #a7b5bc;" > 
            <li style="font-size: small; font-weight: bold">己有权限</li>
     <div style=" overflow: auto; width: 200px; height: 200px;" 
                                id="Div1" runat="server" align="left"  >                                
        <asp:TreeView ID="Acesslist" 
            runat="server" BackColor="White" ForeColor="Black" Height="300px" 
             NodeIndent="10" OnSelectedNodeChanged="Acesslist_SelectedNodeChanged" 
             ShowExpandCollapse="False" Width="180px" >
              <HoverNodeStyle Font-Underline="True" ForeColor="#5555DD" />
              <NodeStyle Font-Names="Verdana" Font-Size="8pt" ForeColor="Black" 
                  HorizontalPadding="0px" NodeSpacing="0px" VerticalPadding="0px" />
              <ParentNodeStyle Font-Bold="False" />
              <SelectedNodeStyle ForeColor="#5555DD" Font-Underline="True" 
                  HorizontalPadding="0px" VerticalPadding="0px" />
        </asp:TreeView></div></td>
        <td align="center" width="100"> 
            <asp:Button ID="btnAdd" runat="server" Text="<<" 
                class="btn1" onclick="btnAdd_Click" /><br />        
            <br />
            <asp:Button ID="btnMinus" 
                runat="server" Text=">>" class="btn1" onclick="btnMinus_Click" /></td>
        <td style="border: thin solid #a7b5bc;"> 
            <li style="font-size: small; font-weight: bold">未分配权限</li>
         <div style=" overflow: auto; width: 200px; height: 200px;" 
                                id="Div2" runat="server"  >
          <asp:TreeView ID="Denylist" runat="server" Width="180px" Height="300px" BackColor="White"
                            ForeColor="Black" OnSelectedNodeChanged="Denylist_SelectedNodeChanged"
                            ShowExpandCollapse="False" NodeIndent="10">
                            <HoverNodeStyle Font-Underline="True" ForeColor="#5555DD" />
    ...
    <li><label>&nbsp;</label>&nbsp;&nbsp; 
        ...
        <asp:Button ID="btnDel" runat="server" Text="删除" class="btndel" onclick="btnDel_Click" 
            /> &nbsp;&nbsp;&nbsp;&nbsp; <asp:Button ID="btnReset" runat="server" Text="重置" class="btnset" onclick="btnReset_Click" 
            /></li>
    </ul>
        </td>
