<%@ WebHandler Language="C#" Class="Inspect_Sensor_getID" %>
...
public class Inspect_Sensor_getID : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        string sql = "select r.inspect_code,s.name as insgroup,r.inspect_name,0 as value,t.lower_value,t.upper_value,r.unit,'' as status,t.minus_score from ht_qlt_inspect_proj r left join ht_inner_inspect_group s on s.id = r.inspect_group left join ht_qlt_inspect_stdd_sub t on t.inspect_code = r.inspect_code and t.is_del = '0' where r.inspect_group = '4' and r.is_del = '0' order by r.inspect_code";
