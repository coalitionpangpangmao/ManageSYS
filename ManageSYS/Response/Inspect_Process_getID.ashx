<%@ WebHandler Language="C#" Class="Inspect_Process__getID" %>
...
using System.Data;
public class Inspect_Process__getID : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        string sql = "select r.inspect_code,s.section_name ,r.inspect_name,0 as value,t.lower_value,t.upper_value,r.unit,'' as status,t.minus_score from ht_qlt_inspect_proj r left join ht_pub_tech_section s on s.section_code = r.inspect_group left join ht_qlt_inspect_stdd_sub t on t.inspect_code = r.inspect_code and t.is_del = '0' left join ht_pub_prod_design hpp on hpp.inspect_stdd = t.stdd_code  where r.inspect_type = '0' and r.is_del = '0' and hpp.prod_code = '"+prodcode+"' order by r.inspect_code";
        ...
        for (int i = 0; i < data.Tables[0].Rows.Count; i++)
        {
            ...
            titles.Add(data.Tables[0].Rows[i][0].ToString());
        }
        json.Add("id", titles);
