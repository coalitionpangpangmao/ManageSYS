<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EquipmentInfo1.aspx.cs" Inherits="Device_EquipmentInfo" %>
   ...
   <asp:TextBox ID="txtPrtnode" runat="server" class="easyui-combobox"  Width ="150" Height ="25"  ></asp:TextBox>
                                            ...
                                            <tr>
                                                <td colspan="4" align="center">
                                                    ...
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <asp:Button ID="btn3Del" runat="server" Text="删除" CssClass="btndel auth" OnClick="btn3Del_Click"  OnClientClick="javascript:return confirm('确认删除？');"/>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
