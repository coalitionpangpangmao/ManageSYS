<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MtncPlan.aspx.cs" Inherits="Device_MtncPlan" %>
            ...
            <div id="tab1" class="tabson">
                <div class="framelist">
                    ...
                    <div id="usual2" class="usual">
                        <div class="itab">
                            <ul>
                                <li><a href="#tab3" class="selected" id="tabtop3">维保计划</a></li>
                                <li><a href="#tab4" id="tabtop4">维保模版</a></li>
                            </ul>
                        </div>
                    </div>
             ...
             <asp:LinkButton ID="btnGo" runat="server" CausesValidation="False" CommandArgument="-2"
                 CommandName="Page" Text="跳转" />
                                ...
                                <Triggers>
                                    <asp:AsyncPostBackTrigger ControlID="btnSearch" />
                                    <asp:AsyncPostBackTrigger ControlID="btnGrid4Del" />
                                    <asp:AsyncPostBackTrigger ControlID="btnGrid4New" />
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            ...
                            <div class="listtitle" style="margin-top: 10px">
                                维保计划明细<span style="position: relative; display: inline-block;">
