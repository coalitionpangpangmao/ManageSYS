            ...
            <div id="tab1" class="tabson">
                <div class="framelist">
                    ...
                    <div class="listtitle" style="margin-top: 10px">
                        设备列表<span style="position: relative; float: right"><asp:Button ID="Button1" runat="server"
                    ...
                    <div>
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:GridView ID="GridView1" runat="server" class="grid" DataKeyNames="设备编码" AllowPaging="True">
                                    <Columns>
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" valign="top">
                                            <div style="height: 300px; overflow: scroll">
                                                <asp:TreeView ID="tvClass" runat="server" Width="450px" ImageSet="BulletedList3"
                                                    ShowExpandCollapse="False" ExpandDepth="3">
