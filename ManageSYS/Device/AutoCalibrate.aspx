            ...
            <div id="usual1" class="usual">
                <div class="itab">
                    <ul>
                        ...
                        <li><a href="#tab2" id="tabtop2">自动采样校准记录</a></li>
                    </ul>
                </div>
            </div>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                           ...
                           <asp:TemplateField   HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"  HeaderText="数据点">
                                    ...
                                    <asp:TemplateField   HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"  HeaderText="设定值">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtGridOldvalue" runat="server" DataValueField="原值" DataTextField="原值"
                                                CssClass="tbinput" Enabled="false"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField   HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"  HeaderText="测量值">
                                        <ItemTemplate>
