...
<body>
    ...
    <div class="formbody">
                ...
                <table class="tablelist">
                    ...
                    <div class="listtitle">
                        列表 <span style="position: relative; float: right">
                            ...
                            <asp:Button ID="btnAprvAll" runat="server" Width = "110px" CssClass="btnview" Text="批量审批" OnClick="btnAprvAll_Click" /></span>
                    </div>
                    <div>                  
                      <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                    <asp:GridView ID="GridView1" runat="server" class="grid" DataKeyNames="ID,gongwen_ID,BUSIN_ID" 
                          ...
                          <asp:TemplateField  HeaderText = "主业务审批状态">
                                     ...
                                     <asp:TemplateField  HeaderText = "当前流程状态">
                                      ...
                                      <asp:TemplateField  HeaderText = "操作" HeaderStyle-HorizontalAlign="Center">
                                        <ItemTemplate>  
                                             <asp:Button ID="btnDetail" runat="server" Text="业务明细" CssClass = "btn1" Width = "80px"  OnClick = "btnDetail_Click"/> 
                                              <asp:Button ID="btnFLow" runat="server" Text="审批流程" CssClass = "aprvclickbtn"  OnClick = "btnFLow_Click" /> 
                                               <asp:Button ID="btnTable" runat="server" Text="查看审批单" CssClass = "btn1" Width = "80px"  OnClick = "btnTable_Click"/>
        ...
        <div id="tab2" class="tabson">
                ...
                <th><asp:RadioButton ID="rdAprv1" runat="server" Text = "同意"  GroupName="Group1" 
                        oncheckedchanged="rdAprv1_CheckedChanged" AutoPostBack="True" />
                    <asp:RadioButton ID="rdAprv2"  runat="server"  Text = "不同意"  GroupName="Group1"
                    oncheckedchanged="rdAprv2_CheckedChanged" AutoPostBack="True"/>
                    <asp:HiddenField ID="hideAprvid" runat="server" />
                </th>
                <th>
                 <asp:Button ID="btnSure" runat="server" Text="确定" CssClass = "btnmodify"   onclick="btnSure_Click"  /> 
                </th>
                </tr>
                        <tbody>
                            <tr>
                                ...
                                <td colspan="2">
                                    <asp:TextBox ID="txtComments" runat="server" class="aprvtxt"  Height = "70px" 
